...
main=Tk()
main.title("BASIC ARITHMETIC CALCULATOR")
...
Button(main,text='7',width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: show("7")).place(x=0,y=200)
...
Button(main,text='4',width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: show("4")).place(x=0,y=300)
...
Button(main,text='1',width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: show("1")).place(x=0,y=400)
